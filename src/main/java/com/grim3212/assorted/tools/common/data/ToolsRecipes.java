...
public class ToolsRecipes extends RecipeProvider {
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
		...
		UpgradeRecipeBuilder.smithing(Ingredient.of(ToolsItems.DIAMOND_BUCKET.get()), Ingredient.of(Tags.Items.INGOTS_NETHERITE), ToolsItems.NETHERITE_BUCKET.get()).unlocks("has_netherite_ingot", has(Tags.Items.INGOTS_NETHERITE)).save(consumer, ToolsItems.NETHERITE_BUCKET.get().getRegistryName() + "_smithing");
		UpgradeRecipeBuilder.smithing(Ingredient.of(ToolsItems.DIAMOND_SHEARS.get()), Ingredient.of(Tags.Items.INGOTS_NETHERITE), ToolsItems.NETHERITE_SHEARS.get()).unlocks("has_netherite_ingot", has(Tags.Items.INGOTS_NETHERITE)).save(consumer, ToolsItems.NETHERITE_SHEARS.get().getRegistryName() + "_smithing");
