...
public class ToolsRecipes extends RecipeProvider implements IConditionBuilder {
	...
	private void shearPattern(ItemLike output, TagKey<Item> input, Consumer<FinishedRecipe> consumer) {
		ConditionalRecipe.builder().addCondition(new EnabledCondition(EnabledCondition.MORE_SHEARS_CONDITION)).addCondition(not(tagEmpty(input))).addRecipe(ShapedRecipeBuilder.shaped(output).define('I', input).define('L', Tags.Items.LEATHER).pattern(" I").pattern("IL").unlockedBy("has_leather", has(Tags.Items.LEATHER)).unlockedBy("has_item", has(input))::save).generateAdvancement().build(consumer, key(output.asItem()));
		ConditionalRecipe.builder().addCondition(new EnabledCondition(EnabledCondition.MORE_SHEARS_CONDITION)).addCondition(not(tagEmpty(input))).addRecipe(ShapedRecipeBuilder.shaped(output).define('I', input).define('L', Tags.Items.LEATHER).pattern("LI").pattern("I ").unlockedBy("has_leather", has(Tags.Items.LEATHER)).unlockedBy("has_item", has(input))::save).generateAdvancement().build(consumer, new ResourceLocation(key(output.asItem()) + "_alt"));
	}
	...
	private void bucketPattern(ItemLike output, TagKey<Item> input, Consumer<FinishedRecipe> consumer) {
		ConditionalRecipe.builder().addCondition(new EnabledCondition(EnabledCondition.BETTER_BUCKETS_CONDITION)).addCondition(not(tagEmpty(input))).addRecipe(ShapedRecipeBuilder.shaped(output).define('I', input).pattern("I I").pattern(" I ").unlockedBy("has_item", has(input))::save).generateAdvancement().build(consumer, key(output.asItem()));
	}
	...
	private void spearPattern(ItemLike output, TagKey<Item> input, Consumer<FinishedRecipe> consumer) {
		ConditionalRecipe.builder().addCondition(new EnabledCondition(EnabledCondition.BETTER_SPEARS_CONDITION)).addCondition(not(tagEmpty(input))).addRecipe(ShapedRecipeBuilder.shaped(output).define('S', Tags.Items.RODS_WOODEN).define('I', input).pattern("I  ").pattern(" S ").pattern("  S").unlockedBy("has_item", has(input))::save).generateAdvancement().build(consumer, key(output.asItem()));
		ConditionalRecipe.builder().addCondition(new EnabledCondition(EnabledCondition.BETTER_SPEARS_CONDITION)).addCondition(not(tagEmpty(input))).addRecipe(ShapedRecipeBuilder.shaped(output).define('S', Tags.Items.RODS_WOODEN).define('I', input).pattern("SSI").unlockedBy("has_item", has(input))::save).generateAdvancement().build(consumer, new ResourceLocation(key(output.asItem()) + "_alt"));
	}
	...
	private void hammerPattern(ItemLike output, TagKey<Item> input, Consumer<FinishedRecipe> consumer) {
		ConditionalRecipe.builder().addCondition(new EnabledCondition(EnabledCondition.HAMMERS_CONDITION)).addCondition(not(tagEmpty(input))).addRecipe(ShapedRecipeBuilder.shaped(output).define('S', Tags.Items.RODS_WOODEN).define('I', input).pattern("III").pattern("ISI").pattern(" S ").unlockedBy("has_item", has(input))::save).generateAdvancement().build(consumer, key(output.asItem()));
	}
	...
	private void toolSet(ItemLike pickaxe, ItemLike shovel, ItemLike axe, ItemLike hoe, ItemLike sword, TagKey<Item> input, Consumer<FinishedRecipe> consumer, String condition) {
		ConditionalRecipe.builder().addCondition(new EnabledCondition(condition)).addCondition(not(tagEmpty(input))).addRecipe(ShapedRecipeBuilder.shaped(pickaxe).define('X', input).define('S', Tags.Items.RODS_WOODEN).pattern("XXX").pattern(" S ").pattern(" S ").unlockedBy("has_item", has(input))::save).generateAdvancement().build(consumer, key(pickaxe.asItem()));
		ConditionalRecipe.builder().addCondition(new EnabledCondition(condition)).addCondition(not(tagEmpty(input))).addRecipe(ShapedRecipeBuilder.shaped(shovel).define('X', input).define('S', Tags.Items.RODS_WOODEN).pattern("X").pattern("S").pattern("S").unlockedBy("has_item", has(input))::save).generateAdvancement().build(consumer, key(shovel.asItem()));
		ConditionalRecipe.builder().addCondition(new EnabledCondition(condition)).addCondition(not(tagEmpty(input))).addRecipe(ShapedRecipeBuilder.shaped(axe).define('X', input).define('S', Tags.Items.RODS_WOODEN).pattern("XX").pattern("XS").pattern(" S").unlockedBy("has_item", has(input))::save).generateAdvancement().build(consumer, key(axe.asItem()));
		ConditionalRecipe.builder().addCondition(new EnabledCondition(condition)).addCondition(not(tagEmpty(input))).addRecipe(ShapedRecipeBuilder.shaped(axe).define('X', input).define('S', Tags.Items.RODS_WOODEN).pattern("XX").pattern("SX").pattern("S ").unlockedBy("has_item", has(input))::save).generateAdvancement().build(consumer, new ResourceLocation(AssortedTools.MODID, key(axe.asItem()).getPath() + "_alt"));
		ConditionalRecipe.builder().addCondition(new EnabledCondition(condition)).addCondition(not(tagEmpty(input))).addRecipe(ShapedRecipeBuilder.shaped(hoe).define('X', input).define('S', Tags.Items.RODS_WOODEN).pattern("XX").pattern(" S").pattern(" S").unlockedBy("has_item", has(input))::save).generateAdvancement().build(consumer, key(hoe.asItem()));
		ConditionalRecipe.builder().addCondition(new EnabledCondition(condition)).addCondition(not(tagEmpty(input))).addRecipe(ShapedRecipeBuilder.shaped(hoe).define('X', input).define('S', Tags.Items.RODS_WOODEN).pattern("XX").pattern("S ").pattern("S ").unlockedBy("has_item", has(input))::save).generateAdvancement().build(consumer, new ResourceLocation(AssortedTools.MODID, key(hoe.asItem()).getPath() + "_alt"));
		ConditionalRecipe.builder().addCondition(new EnabledCondition(condition)).addCondition(not(tagEmpty(input))).addRecipe(ShapedRecipeBuilder.shaped(sword).define('X', input).define('S', Tags.Items.RODS_WOODEN).pattern("X").pattern("X").pattern("S").unlockedBy("has_item", has(input))::save).generateAdvancement().build(consumer, key(sword.asItem()));
	}
	...
	private void armorSet(ItemLike helmet, ItemLike chestplate, ItemLike leggings, ItemLike boots, TagKey<Item> input, Consumer<FinishedRecipe> consumer, String condition) {
		ConditionalRecipe.builder().addCondition(new EnabledCondition(condition)).addCondition(not(tagEmpty(input))).addRecipe(ShapedRecipeBuilder.shaped(helmet).define('X', input).pattern("XXX").pattern("X X").unlockedBy("has_item", has(input))::save).generateAdvancement().build(consumer, key(helmet.asItem()));
		ConditionalRecipe.builder().addCondition(new EnabledCondition(condition)).addCondition(not(tagEmpty(input))).addRecipe(ShapedRecipeBuilder.shaped(chestplate).define('X', input).pattern("X X").pattern("XXX").pattern("XXX").unlockedBy("has_item", has(input))::save).generateAdvancement().build(consumer, key(chestplate.asItem()));
		ConditionalRecipe.builder().addCondition(new EnabledCondition(condition)).addCondition(not(tagEmpty(input))).addRecipe(ShapedRecipeBuilder.shaped(leggings).define('X', input).pattern("XXX").pattern("X X").pattern("X X").unlockedBy("has_item", has(input))::save).generateAdvancement().build(consumer, key(leggings.asItem()));
		ConditionalRecipe.builder().addCondition(new EnabledCondition(condition)).addCondition(not(tagEmpty(input))).addRecipe(ShapedRecipeBuilder.shaped(boots).define('X', input).pattern("X X").pattern("X X").unlockedBy("has_item", has(input))::save).generateAdvancement().build(consumer, key(boots.asItem()));
	}
