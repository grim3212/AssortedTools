...
public class ToolsCreativeTab {
	...
	public static void registerTabs(final CreativeModeTabEvent.Register event) {
		event.registerCreativeModeTab(new ResourceLocation(AssortedTools.MODID, "tab"), builder -> builder.title(Component.translatable("itemGroup.assortedtools")).icon(() -> new ItemStack(ToolsItems.IRON_HAMMER.get())).displayItems((enabledFlags, populator, hasPermissions) -> {
