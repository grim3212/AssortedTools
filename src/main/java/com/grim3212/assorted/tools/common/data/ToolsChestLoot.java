...
public class ToolsChestLoot extends ChestLoot {
	...
	public void accept(BiConsumer<ResourceLocation, Builder> builder) {
		...
		builder.accept(new ResourceLocation(AssortedTools.MODID, "fragments_overworld_loot"), ultimateFragmentOverworldLootTable);
		...
		builder.accept(new ResourceLocation(AssortedTools.MODID, "fragments_nether_loot"), ultimateFragmentNetherLootTable);
		...
		builder.accept(new ResourceLocation(AssortedTools.MODID, "fragments_end_loot"), ultimateFragmentEndLootTable);
	}
