...
public class ToolsRecipes extends RecipeProvider {
	...
	protected void registerRecipes(Consumer<IFinishedRecipe> consumer) {
		...
		ConditionalRecipe.builder().addCondition(new EnabledCondition("boomerangs")).addRecipe(ShapedRecipeBuilder.shapedRecipe(ToolsItems.WOOD_BOOMERANG.get()).key('X', ItemTags.PLANKS).patternLine("XX").patternLine("X ").patternLine("XX").addCriterion("has_planks", hasItem(ItemTags.PLANKS))::build).build(consumer, ToolsItems.WOOD_BOOMERANG.get().getRegistryName());
		ConditionalRecipe.builder().addCondition(new EnabledCondition("boomerangs")).addRecipe(ShapedRecipeBuilder.shapedRecipe(ToolsItems.DIAMOND_BOOMERANG.get()).key('X', Tags.Items.GEMS_DIAMOND).key('Y', ToolsItems.WOOD_BOOMERANG.get()).patternLine("XX").patternLine("XY").patternLine("XX").addCriterion("has_diamonds", hasItem(Tags.Items.GEMS_DIAMOND))::build).build(consumer, ToolsItems.DIAMOND_BOOMERANG.get().getRegistryName());
		ConditionalRecipe.builder().addCondition(new EnabledCondition("pokeball")).addRecipe(ShapedRecipeBuilder.shapedRecipe(ToolsItems.POKEBALL.get()).key('R', Tags.Items.DUSTS_REDSTONE).key('C', ItemTags.COALS).key('I', Tags.Items.INGOTS_IRON).key('B', Items.STONE_BUTTON).patternLine("RRR").patternLine("CBC").patternLine("III").addCriterion("has_iron", hasItem(Tags.Items.INGOTS_IRON)).addCriterion("has_redstone", hasItem(Tags.Items.DUSTS_REDSTONE))::build).build(consumer, ToolsItems.POKEBALL.get().getRegistryName());

		ConditionalRecipe.builder().addCondition(new EnabledCondition("wands")).addRecipe(ShapedRecipeBuilder.shapedRecipe(ToolsItems.BUILDING_WAND.get()).key('X', ItemTags.PLANKS).key('G', Tags.Items.INGOTS_GOLD).patternLine("XGX").patternLine("XGX").patternLine("XGX").addCriterion("has_gold", hasItem(Tags.Items.INGOTS_GOLD))::build).build(consumer, ToolsItems.BUILDING_WAND.get().getRegistryName());
		ConditionalRecipe.builder().addCondition(new EnabledCondition("wands")).addRecipe(ShapedRecipeBuilder.shapedRecipe(ToolsItems.BREAKING_WAND.get()).key('X', ItemTags.PLANKS).key('G', Tags.Items.INGOTS_IRON).patternLine("XGX").patternLine("XGX").patternLine("XGX").addCriterion("has_iron", hasItem(Tags.Items.INGOTS_IRON))::build).build(consumer, ToolsItems.BREAKING_WAND.get().getRegistryName());
		ConditionalRecipe.builder().addCondition(new EnabledCondition("wands")).addRecipe(ShapedRecipeBuilder.shapedRecipe(ToolsItems.MINING_WAND.get()).key('X', ItemTags.PLANKS).key('G', Tags.Items.GEMS_DIAMOND).patternLine("XGX").patternLine("XGX").patternLine("XGX").addCriterion("has_diamond", hasItem(Tags.Items.GEMS_DIAMOND))::build).build(consumer, ToolsItems.MINING_WAND.get().getRegistryName());
		ConditionalRecipe.builder().addCondition(new EnabledCondition("wands")).addRecipe(ShapedRecipeBuilder.shapedRecipe(ToolsItems.REINFORCED_BUILDING_WAND.get()).key('X', Tags.Items.OBSIDIAN).key('G', Tags.Items.STORAGE_BLOCKS_GOLD).patternLine("XGX").patternLine("XGX").patternLine("XGX").addCriterion("has_obsidian", hasItem(Tags.Items.OBSIDIAN))::build).build(consumer, ToolsItems.REINFORCED_BUILDING_WAND.get().getRegistryName());
		ConditionalRecipe.builder().addCondition(new EnabledCondition("wands")).addRecipe(ShapedRecipeBuilder.shapedRecipe(ToolsItems.REINFORCED_BREAKING_WAND.get()).key('X', Tags.Items.OBSIDIAN).key('G', Tags.Items.STORAGE_BLOCKS_IRON).patternLine("XGX").patternLine("XGX").patternLine("XGX").addCriterion("has_obsidian", hasItem(Tags.Items.OBSIDIAN))::build).build(consumer, ToolsItems.REINFORCED_BREAKING_WAND.get().getRegistryName());
		ConditionalRecipe.builder().addCondition(new EnabledCondition("wands")).addRecipe(ShapedRecipeBuilder.shapedRecipe(ToolsItems.REINFORCED_MINING_WAND.get()).key('X', Tags.Items.OBSIDIAN).key('G', Tags.Items.STORAGE_BLOCKS_DIAMOND).patternLine("XGX").patternLine("XGX").patternLine("XGX").addCriterion("has_obsidian", hasItem(Tags.Items.OBSIDIAN))::build).build(consumer, ToolsItems.REINFORCED_MINING_WAND.get().getRegistryName());
	...
	private void hammerPattern(IItemProvider output, ITag<Item> input, Consumer<IFinishedRecipe> consumer) {
		ConditionalRecipe.builder().addCondition(new EnabledCondition("hammers")).addRecipe(ShapedRecipeBuilder.shapedRecipe(output).key('S', Tags.Items.RODS_WOODEN).key('I', input).patternLine("III").patternLine("ISI").patternLine(" S ").addCriterion("has_item", hasItem(input))::build).build(consumer, output.asItem().getRegistryName());
	}
	...
	private void armorSet(IItemProvider helmet, IItemProvider chestplate, IItemProvider leggings, IItemProvider boots, ITag<Item> input, Consumer<IFinishedRecipe> consumer) {
		ConditionalRecipe.builder().addCondition(new EnabledCondition("chickensuit")).addRecipe(ShapedRecipeBuilder.shapedRecipe(helmet).key('X', input).patternLine("XXX").patternLine("X X").addCriterion("has_item", hasItem(input))::build).build(consumer, helmet.asItem().getRegistryName());
		ConditionalRecipe.builder().addCondition(new EnabledCondition("chickensuit")).addRecipe(ShapedRecipeBuilder.shapedRecipe(chestplate).key('X', input).patternLine("X X").patternLine("XXX").patternLine("XXX").addCriterion("has_item", hasItem(input))::build).build(consumer, chestplate.asItem().getRegistryName());
		ConditionalRecipe.builder().addCondition(new EnabledCondition("chickensuit")).addRecipe(ShapedRecipeBuilder.shapedRecipe(leggings).key('X', input).patternLine("XXX").patternLine("X X").patternLine("X X").addCriterion("has_item", hasItem(input))::build).build(consumer, leggings.asItem().getRegistryName());
		ConditionalRecipe.builder().addCondition(new EnabledCondition("chickensuit")).addRecipe(ShapedRecipeBuilder.shapedRecipe(boots).key('X', input).patternLine("X X").patternLine("X X").addCriterion("has_item", hasItem(input))::build).build(consumer, boots.asItem().getRegistryName());
	}
